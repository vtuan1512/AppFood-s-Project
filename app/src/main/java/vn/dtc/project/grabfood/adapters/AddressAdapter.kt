...
import vn.dtc.project.grabfood.databinding.AddressRvItemBinding
            ...
            ViewHolder(binding.root){
                fun bind(address: Address, isSelected: Boolean){
                    binding.apply {
                        ...
                        if (isSelected){
                            buttonAddress.background = ColorDrawable(itemView.context.resources.getColor(R.color.g_gray500))
                        }else{
