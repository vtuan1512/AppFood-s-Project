...
import vn.dtc.project.grabfood.data.Order.getOrderStatus
import vn.dtc.project.grabfood.databinding.FragmentOrderDetailBinding
...
class OrderDetailFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            tvAddress.text = order.address.addressTitle
            tvPhoneNumber.text  = order.address.phone
            tvTotalPrice.text = "$ ${order.totalPrice}"

        }
        billingFoodAdapter.differ.submitList(order.food)
    }
